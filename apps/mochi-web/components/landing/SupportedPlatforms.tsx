  ...
  return (
    <div className="flex flex-col gap-y-3 justify-center items-center p-6 border-r border-b border-neutral-outline-border">
      <div className="relative">
        ...
        />
        {comingSoon && (
          <span className="absolute bottom-0 left-1/2 px-1 leading-3 rounded-full border -translate-x-1/2 translate-y-1/2 text-xxxs bg-neutral-soft border-neutral-outline-border">
            soon
          </span>
        )}
      </div>
...
export function SupportedPlatforms() {
  return (
    <div className="hidden flex-col mt-10 md:flex landing-container">
      <p className="text-3xl font-semibold text-center font-text text-text-primary">
        Supported platforms
      </p>
