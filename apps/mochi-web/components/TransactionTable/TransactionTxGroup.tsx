...
export const TransactionTxGroup = (props: TransactionTxGroupProps) => {
  ...
  return (
    ...
    >
      <SelectTrigger className="!rounded-full !bg-background-level1 border !border-background-level3 !py-0.5 !px-2 !h-[20px] !font-normal !w-[80px] justify-between gap-x-0">
