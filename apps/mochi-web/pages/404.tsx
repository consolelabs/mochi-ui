  ...
  return (
    <Layout>
      ...
      <div
        ...
        >
          <h3 className='font-medium text-2xl sm:text-3xl'>We lost this page</h3>
          <p className='sm:text-lg text-sm'>The page you are looking for doesn&apos;t exist or has been moved</p>
          <div className='flex gap-3 sm:w-fit sm:flex-row flex-col-reverse w-full'>
            ...
            <Link href={ROUTES.HOME}>
              <Button className='text-base shadow-none !bg-blue-700 text-white !border-blue-700 h-12 w-full sm:w-[144px]'
                href={ROUTES.HOME}
              >
                Confirm
              </Button>
