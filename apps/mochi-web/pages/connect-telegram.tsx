    ...
    <Layout>
      ...
      <div className="flex relative flex-col items-center">
        <div className="py-16 px-12 mx-auto max-w-7xl">
          <div className="py-24 md:py-48">{renderContent()}</div>
        </div>
      </div>
    </Layout>
  )
