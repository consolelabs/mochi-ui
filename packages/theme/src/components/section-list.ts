...
const sectionListViewportClsx = ({ className = '' }: { className?: string }) =>
...
const sectionListScrollbarClsx = ({ className = '' }: { className?: string }) =>
  clsx(
    'flex select-none touch-none p-0.5 bg-gray-200 transition-colors w-2 hover:bg-gray-300',
    className,
  )

const sectionListThumbClsx = ({ className = '' }: { className?: string }) =>
  clsx(
...
const sectionListCornerClsx = ({ className = '' }: { className?: string }) =>
