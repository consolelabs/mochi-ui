        ...
        return (
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <button className="ui-p-2 ui-bg-primary-500 ui-text-white ui-rounded-md" type="button">Open Dropdown</button>
                </DropdownMenuTrigger>
                <DropdownMenuContent>
                    <DropdownMenuLabel leftIcon={<IconClose/>}>My Account</DropdownMenuLabel>
                    <DropdownMenuGroup>
                        {MenuItems({checked: selected, setSelected}).map((props, index) => (
                    ...
                    <DropdownMenuSub>
                        ...
                        <DropdownMenuPortal>
                        <DropdownMenuSubContent>
                            <DropdownMenuRadioGroup value={radioSelected} onChange={(val) => setRadioSelected(val)}>
                                {([
                                    {
                                        children: "Console Labs",
                                        subTitle: <span className="ui-flex ui-gap-1 ui-items-center">Lvl 450 <IconSolidDot/> 145 Boosts</span>,
                                ...
                                ] as DropdownRadioItemProps[]).map((props, index) => (
                    ...
                    <DropdownMenuSeparator/>
                    <DropdownMenuItem className="ui-text-red-600" leftIcon={<IconArrow className="ui-text-red-600" />}>Logout</DropdownMenuItem>
