                ...
                <ModalContent className="space-y-2 text-center max-w-sm">
                    <div className="mb-8 flex flex-col gap-5 items-center">
                        ...
                        <div>
                            ...
                            <ModalDescription>
                            ETH selected as the transfer network. Few platforms support the ETH network. Please confirm that the receiving platform supports this network. 
                            </ModalDescription>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        <ModalTrigger asChild>
                            <button className="flex-1 border border-neutral-300 py-3 px-6 rounded-lg" type="button">
                                Cancel
                            </button>
                        </ModalTrigger>
                        <ModalTrigger asChild>
