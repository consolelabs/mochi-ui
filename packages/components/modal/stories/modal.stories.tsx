      ...
      <Modal modal={modal}>
        ...
        <ModalPortal>
          ...
          <ModalContent className="space-y-2">
            ...
            <ModalDescription>
              This is a modal description. This is a modal description. This is
              a modal description. This is a modal description.
            </ModalDescription>
          </ModalContent>
        </ModalPortal>
      </Modal>
          ...
          <ModalContent className="space-y-2 text-center max-w-sm">
            <div className="mb-8 flex flex-col gap-5 items-center">
              ...
              <div>
                ...
                <ModalDescription>
                  ETH selected as the transfer network. Few platforms support
                  the ETH network. Please confirm that the receiving platform
